...
st.sidebar.markdown('<div style="padding: 0px 0px 0px 80px;"><img src="TF_Logo.png" width="100" height="100"></div>', unsafe_allow_html=True)  # Logo with padding
st.sidebar.markdown('<div style="padding: 0px 0px 0 80px;"><h1>TmrFace</h1></div>', unsafe_allow_html=True)
