...
from plotting_pred import plot_prediction_chart
from stock_info import get_live_stock_price
from stock_info_display import display_stock_info  # Import the updated function from stock_info_display.py
